...
namespace PolluxNet.WindowStyle
{
    public class MonitorHelper
    {
        ...
        private MonitorHelper(IntPtr monitor, IntPtr hdc)
        {
        ...
        public static MonitorHelper GetCurrentMonitor(IntPtr hwnd)
        {
            return new MonitorHelper(MonitorFromWindow(hwnd, 2), IntPtr.Zero);
        }

        public static IEnumerable<MonitorHelper> AllMonitors
        {
            get
            {
                ...
                return closure.Monitors.Cast<MonitorHelper>();
            }
        }
        ...
        private class MonitorEnumCallback
        {
            ...
            {
                Monitors.Add(new MonitorHelper(monitor, hdc));
                return true;
            }
        }
    }
